...
namespace ImageGallery.API.Controllers
{
    ...
    public class ImagesController : ControllerBase
    {
        ...
        public ImagesController(IGalleryRepository galleryRepository, IWebHostEnvironment hostingEnvironment,
            IMapper mapper)
        {
        ...
        public async Task<ActionResult<IEnumerable<Image>>> GetImages()
        {
            var ownerId = User.Claims
                .FirstOrDefault(lbda => lbda.Type == "sub")?.Value;
        ...
        public async Task<ActionResult<Image>> GetImage(Guid id)
        {
            ...
            if (imageFromRepo is null) return NotFound();
